          ...
          <div className="max-w-3xl mx-auto text-center text-white">
            ...
            <div className="relative max-w-xl mx-auto">
              <input
                ...
                className="w-full px-5 py-3 pr-12 rounded-lg bg-white/10 backdrop-blur-sm border border-white/20 text-white placeholder-white/60 focus:outline-none focus:ring-2 focus:ring-secondary"
              />
            ...
            <div className="lg:w-1/3">
              ...
              <div className="bg-primary rounded-xl shadow-md p-6 text-white">
                ...
                <input
                  ...
                  className="w-full px-4 py-2 rounded-lg bg-white/10 backdrop-blur-sm border border-white/20 text-white placeholder-white/60 focus:outline-none focus:ring-2 focus:ring-secondary mb-3"
                />
